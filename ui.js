...
function openSheet(html, opts={}){
  ...
  sheetEl.innerHTML = `<div class="sheet-drag-zone"><div class="sheet-grip"></div></div><button class="sheet-close" id="sheetCloseBtn" aria-label="Kapat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg></button>` + html;
