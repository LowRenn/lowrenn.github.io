...
function openTrackEditSheet(draft, isNew){
  ...
  openSheet(`
    ...
    <div class="sheet-scroll">
      ...
      <div class="field"><label>Açıklama</label><textarea id="fDesc" maxlength="75" placeholder="Bu parça hakkında birkaç kelime…">${escapeHtml(draft.description)}</textarea></div>
